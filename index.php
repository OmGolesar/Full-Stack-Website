...
<body>
    ...
    <div class="product" id="product">
        ...
        <div class="productDetails">
            ...
            <p class="productDesc">
                Air Force shoes, often referred to as Air Force 1s, are iconic sneakers originally designed by Nike in 1982.  
                The shoes feature a classic silhouette with a low-top or high-top design, 
                a chunky sole with air cushioning technology for comfort, and a leather or synthetic upper. 
                Air Force shoes are known for their durability, versatility, and timeless style, 
                making them a popular choice for casual wear and sneaker collectors alike..</p>
                 <div class="colors">
                <div class="color"></div>
                <div class="color"></div>
            </div>
        ...
        <div class="payment" style="text-align: center; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 20px;">
    <h1 class="payTitle" style="font-size: 24px; color: #333; margin-bottom: 20px;">Your order has been placed!</h1>
    <img src="logoo.png" alt="Order Placed" >
    <p style="font-size: 16px; color: #666;">Thank you for your purchase. Your order has been successfully placed.</p>
</div>
    ...
    <footer>
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu">
                <span class="copyright">@Niraj MOre. All rights reserved. 2024.</span>
            </div>
        </div>
    </footer>
